...
export default function Functionalities({ 
    ...
    return (
        <div className={functStyle.funct__container}>
            <SearchCard/>
            <button 
                className={functStyle.show__add__card__button} 
                onClick={() => changePopUpToVisible('addCard')}
            >
                <Image 
                    src={AddIcon} 
                    alt='add icon' 
                    className={functStyle.add__icon}
                />           
                Add card
            </button>
            <AddCard />
            {isGroup && (
                <div className={functStyle.group__token__block}>
                    <p 
                        className={functStyle.group__token} 
                        ref={hashTextRef}
                    > 
                        {currentGroupId} 
                    </p>
                    <button 
                        className={functStyle.copy__token__button} 
                        onClick={copyHash}
                    >
                        <Image 
                            src={ClipIcon} 
                            alt='copy icon' 
                            className={functStyle.copy__icon}
                        />
                    </button>
                </div>
            )}
