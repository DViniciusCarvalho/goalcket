...
export default function AddCard() {
    ...
    return (
        <div 
            className={`
                ${functStyle.add__card__container} 
                ${functStyle[addCardPopUpVisibility]}
                `
            }
        >
            ...
            <div className={functStyle.new__card__info}>
                <div className={functStyle.destination__block}>
                    <label 
                        htmlFor='c__destination' 
                        className={functStyle.destination__label}
                    >
                        Destination
                    </label>
                    <select 
                        className={functStyle.column__destination} 
                        id='c__destination'
                        ref={destinationRef}
                    >
                ...
                <div className={functStyle.priority__block}>
                    <label 
                        htmlFor='s__priority' 
                        className={functStyle.priority__label}
                    >
                        Priority
                    </label>
                    <select 
                        className={functStyle.priority__select} 
                        id='s__priority' 
                        ref={priorityRef}
                    >
            ...
            <div className={functStyle.content__text__block}>
                <label 
                    htmlFor='content__text' 
                    className={functStyle.context__text__label}
                >
                    Content:
                </label>
                <textarea 
                    id='content__text' 
                    className={functStyle.content__textarea} 
                    ref={contentRef}
                />
            </div>
