...
export default function InternalHeader(){
    ...
    function getUserGroups(): void {
        
        setUserGroups(previous => groups);
    }
    ...
    return (
        <header className={headerStyles.internal__header}>
            ...
            <div className={headerStyles.nav__area}>
                <select 
                    onChange={changeRoom} 
                    className={headerStyles.group__select}
                >
                    <option 
                        value='personal' 
                        id='personal'
                ...
                <button 
                    className={headerStyles.join_group__button} 
