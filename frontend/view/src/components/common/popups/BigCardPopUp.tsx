...
export default function BigCard({ 
    ...
    return (
        <div 
            className={`
                ${bigCardStyle.big__card__container} 
                ${bigCardStyle[bigCardPopUpVisibility]}
                `
            }
        >
            <div className={bigCardStyle.big__card__header}>
                ...
                <div className={bigCardStyle.big__card__info__block}>
                    ...
                    <div className={bigCardStyle.big__card__info__priority}>
                        <p className={bigCardStyle.big__card__info__priority__text}> 
                            Priority: {priority}
                        </p>
                        <div 
                            className={`
                                ${bigCardStyle.big__card__info__priority__colorization} 
                ...
                <div className={bigCardStyle.big__card__buttons__block}>
                    ...
                    <button 
                        onClick={() => handleMoveCardPopUpState(
                            content, 
                            priority, 
                            timestamp, 
                            id, 
            ...
            <p 
                className={bigCardStyle.big__card__content} 
                ref={cardContentRef} 
